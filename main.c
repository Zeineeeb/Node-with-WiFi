...
void config_esp()
{
	...
	SendTxt2("AT+CWMODE=1\r\n");
	Delay(84000000);

	SendTxt2("AT+CWJAP=\"Zeineb AP\",\"amouri@28209866\"");
	SendTxt2("\r\n");
	Delay(84000000);
	Delay(84000000);
	 ...
	 if(ADC2->SR&(1<<1))
	 {
		 ...
		 if(ncount==3)
		 {
			...
			sprintf(BUFFER_request,"GET /update?key=I5DA4OM2PS7CJNWK&field1=%d&field2=%d&field3=%d\r\n",ADC_VALUE[0],ADC_VALUE[1],ADC_VALUE[2]);
		 	//SendTxt2("AT+CIPSTART=\"TCP\",\"www.thingspeak.com\",80\r\n");
		 	SendTxt2("AT+CIPSTART=\"TCP\",\"184.106.153.149\",80\r\n");
		 	//SendTxt2("\r\n");
			Delay(84000000);
		 	N=strlen(BUFFER_request);
